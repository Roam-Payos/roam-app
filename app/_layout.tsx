...
import { RoamProvider } from "@/context/RoamContext";
...
function RootLayoutNav() {
  return (
    <Stack screenOptions={{ headerShown: false, contentStyle: { backgroundColor: "#0B1C3D" } }}>
      <Stack.Screen name="index" options={{ headerShown: false }} />
      <Stack.Screen name="(onboarding)" options={{ headerShown: false }} />
      <Stack.Screen name="(tabs)" options={{ headerShown: false }} />
      <Stack.Screen name="send/index" options={{ presentation: "modal", headerShown: false }} />
      <Stack.Screen name="pay/index" options={{ presentation: "modal", headerShown: false }} />
