...
import { CreditCard, Home, List, PiggyBank, User } from "lucide-react-native";
        ...
        options={{
          ...
          tabBarIcon: ({ color }) =>
            isIOS ? (
              ...
              <CreditCard size={22} color={color} strokeWidth={1.8} />
            ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color }) =>
            isIOS ? (
              ...
              <PiggyBank size={22} color={color} strokeWidth={1.8} />
            ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color }) =>
            isIOS ? (
              ...
              <List size={22} color={color} strokeWidth={1.8} />
            ),
        }}
      />
      <Tabs.Screen
